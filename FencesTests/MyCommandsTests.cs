...
namespace FencesTests
{
    ...
    public class MyCommandsTests
    {
        ...
        {
            int[] segments = SimpleFences.Divide(5000, 0, 3);
        ...
        public void Test()
        {
            int[] segments = SimpleFences.Divide(5000, 0, 1);
            Assert.AreEqual(8, segments.Length);
            Assert.AreEqual(100, segments[0]);
            Assert.AreEqual(800, segments[1]);
        ...
        {
            int[] segments = SimpleFences.Divide(2100, 2, 5);
        ...
        {
            int[] segments = SimpleFences.Divide(200, 0, 3);
        ...
        {
            int[] segments = SimpleFences.Divide(230, 2, 3);
            Assert.AreEqual(2, segments.Length);
